                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(feeds[index].claim,
                            style: GoogleFonts.montserrat(fontSize: 25,fontWeight: FontWeight.w300,)),
                      ),
                    ),
                  ),
                  Positioned(
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: AutoSizeText(
                          'Source: ' + Uri.parse(feeds[index].url1.toString()).host),
                    ),
                  ),
                  Positioned(
            ...
            : Stack(
                children: [
                  Positioned(
                    ...
                    child: Container(
                      padding: EdgeInsets.only(top: Globals.getHeight(30),left: 10,right: 10.0,bottom: 10.0),
                      height: Globals.height * 0.15,
                      width: Globals.width * 0.8,
                      decoration: BoxDecoration(
                          color: Color(0xFFEDF2F4),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: isLoading
          ...
          : feeds.length==0?Center(child: Column(mainAxisAlignment: MainAxisAlignment.center,
        children: [
        ...
        child: SwipeDetector(
          ...
          onSwipeUp: () async {
            try{
              ...
              Globals.currentFeed = feeds[index + 1];
              _goForward();
            }
            catch(e){
              Toast.show('No more posts in this category', context);
            }
          },
          onSwipeDown: () {
            print('Index is: ' + index.toString());
